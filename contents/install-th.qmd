...
ส่วนใหญ่ผมใช้ R console เป็น **"เครื่องคิดเลข"** เพียงชั่วคราวเท่านั้น (ซึ่งก็ดีกว่าเครื่องคิดเลขที่อยู่ใน GUI อยู่มาก) แต่หากเราต้องการใช้งาน R แบบจริงจังเมื่อไร ผมแนะนำให้ใช้ RStudio ซึ่งจะกล่าวถัดไป
